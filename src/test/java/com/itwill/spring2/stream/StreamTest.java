...
// 단위 텍스트에서 @ExtendWith, @ContextConfiguration 애너테이션을 사용할 필요가 없음.
public class StreamTest {
    ...
    public void test() {
        ...
        List<Integer> odds = numbers.stream()
                .filter((x) -> x % 2 == 1) //한 문장이면 {생략가능 ; 리턴문까지
                .toList();
